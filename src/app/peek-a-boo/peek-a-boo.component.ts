import {
  Component, OnInit, SimpleChanges, Input, OnDestroy, AfterViewChecked, AfterViewInit,
  AfterContentChecked, AfterContentInit, DoCheck, OnChanges
} from '@angular/core';
